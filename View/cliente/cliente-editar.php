<h1 class="page-header">
    <?php echo $pvd->idcliente != null ? $pvd->Nombre : 'Nuevo Registro'; ?>
</h1>

<ol class="breadcrumb">
  <li><a href="?c=cliente">Clientes</a></li>
  <li class="active"><?php echo $pvd->idcliente != null ? $pvd->Nombre : 'Nuevo Registro'; ?></li>
</ol>

<form id="frm-cliente" action="?c=cliente&a=Editar" method="post" enctype="multipart/form-data">
    <input type="hidden" name="idcliente" value="<?php echo $pvd->idcliente; ?>" />
